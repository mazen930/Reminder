...
public class RemindersDbAdapter {
    ...
    public Reminder fetchReminderById(int id) {
       Cursor cursor=mDb.rawQuery("select * from "+TABLE_NAME+" where "+ COL_ID +"= "+id,null);
       if(cursor.getCount()>0){
           Reminder reminder=new Reminder(Integer.parseInt(cursor.getString(0)),cursor.getString(1),Integer.parseInt(cursor.getString(2)));
           return reminder;
       }
       else
           return  null;
